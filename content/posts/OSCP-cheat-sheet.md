...
## SSH not interactive
```sh
sshpass -p "monkey" ssh sean@10.11.1.251 
```
## sshutle
```sh
sshuttle -r sean@10.11.1.251 10.1.1.27 # create connect from kali to 10.1.1.27 via 10.11.1.251
```
```sh
sshuttle -r sean@10.11.1.251 10.1.1.0/24 # subnet
```
